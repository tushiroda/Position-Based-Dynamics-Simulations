...
particles = [Particle(0.0, 0.0)] + [
    Particle(-15 * particle_radii + i * particle_radii * 2.2, particle_radii * i)
    for i in range(10)
]


point_constraints = [PointConstraint(0, 0.0, 0.0)]
...
window = glfw.create_window(screen_dimx, screen_dimy, "Point Constraint", None, None)
if not window:
    glfw.terminate()
    exit()
